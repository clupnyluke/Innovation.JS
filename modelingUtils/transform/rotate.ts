...
import { ax1 } from '@modeling/oc_core';
...
const rotate = (
  ...
  transform1.SetRotation_1(ax1({ direction: [1, 0, 0] }), rotation[0] * scale);
  transform2.SetRotation_1(ax1({ direction: [0, 1, 0] }), rotation[1] * scale);
  transform3.SetRotation_1(ax1({ direction: [0, 0, 1] }), rotation[2] * scale);
